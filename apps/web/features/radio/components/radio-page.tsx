        ...
        <>
          {recentStations.length > 0 && (
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">{recentStations.map(renderCard)}</div>
            </div>
          )}

          <div className="mt-8">
            <h2 className="mb-3 text-sm font-semibold text-text-2">{t("allStations")}</h2>
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3">{sorted.map(renderCard)}</div>
          </div>
        </>
      )}
    </section>
