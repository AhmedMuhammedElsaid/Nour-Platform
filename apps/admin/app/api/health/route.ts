...
// mirrors apps/admin/next.config.ts: importing the validated env barrel pulls
// in parseEnv() at module load, which requires MONGODB_URI/AUTH_SECRET to be
// set at `next build` time. The build runs without those in local/preview
